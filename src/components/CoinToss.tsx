...
const CoinToss: React.FC = () => {
  ...
  const [selectedCaptain, setSelectedCaptain] = useState<"alpha" | "beta">(
    "alpha"
  );
  ...
  const handleToss = () => {
    if (!captainChoice) {
      toast({
        ...
        description:
          "Please select a captain and their coin toss choice first.",
        variant: "destructive",
      });
      return;
    }
  ...
  useEffect(() => {
    if (tossResult && !isFlipping) {
      const winningStatus =
        captainChoice?.choice === tossResult ? "won" : "lost";
      toast({
        title: "Toss Result",
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      <Card className="text-center">
        <CardHeader>
          ...
          <CardDescription>
            Time for the captains to face off! First, select which captain will
            call the toss.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center p-8">
          ...
          <div className="mb-8 w-full">
            <RadioGroup
              defaultValue="alpha"
              onValueChange={(value) =>
                setSelectedCaptain(value as "alpha" | "beta")
              }
            ...
            >
              <div className="text-center space-y-2">
                <div className="w-16 h-16 rounded-full bg-blue-500/20 mx-auto overflow-hidden">
                  <img
                    src={
                      teamAlpha.captain?.imageUrl ||
                      "https://ui-avatars.com/api/?name=Alpha&background=random"
                    }
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="alpha" className="font-semibold">
                    {teamAlpha.captain?.name || "Alpha Captain"}
                  </Label>
                </div>
              </div>
              ...
              <div className="text-center space-y-2">
                <div className="w-16 h-16 rounded-full bg-amber-500/20 mx-auto overflow-hidden">
                  <img
                    src={
                      teamBeta.captain?.imageUrl ||
                      "https://ui-avatars.com/api/?name=Beta&background=random"
                    }
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="beta" className="font-semibold">
                    {teamBeta.captain?.name || "Beta Captain"}
                  </Label>
                </div>
              </div>
            </RadioGroup>
            ...
            <div className="bg-muted/20 p-4 rounded-lg">
              <h3 className="text-lg font-medium mb-4">
                {selectedCaptain === "alpha"
                  ? teamAlpha.captain?.name
                  : teamBeta.captain?.name}{" "}
                will call:
              </h3>
              <RadioGroup
                defaultValue={captainChoice?.choice || "heads"}
                onValueChange={(value) =>
                  handleCaptainChoice(value as "heads" | "tails")
                }
              ...
              >
                ...
                <div className="text-center space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="tails" className="font-semibold">
                      Tails
                    </Label>
                  </div>
                </div>
          ...
          <div className="mb-8 flex gap-16 items-center">
            <div className="text-center">
              ...
              <div className="font-semibold">
                {teamAlpha.captain?.name || "No Captain"}
              </div>
            ...
            <div className="text-center">
              ...
              <div className="font-semibold">
                {teamBeta.captain?.name || "No Captain"}
              </div>
          ...
          <div className="perspective-[1000px] mb-8">
            <div
              className={`coin ${isFlipping ? "animate-coin-flip" : ""}`}
          ...
          {tossResult && !isFlipping && (
            <div className="mb-6 mt-5 p-4 bg-primary/10 rounded-lg">
              <div className="text-xl font-medium">
                Result: {tossResult.toUpperCase()}
              </div>
              <div className="flex items-center justify-center mt-2 gap-2">
                <div className="text-lg">
                  <span className="font-semibold">{tossWinningTeam?.name}</span>{" "}
                  wins the toss!
                </div>
              </div>
            </div>
